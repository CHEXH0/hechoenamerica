...
export const ContactFormEmail = ({ name, email, country, subject, message }: ContactFormEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={footer}>
          <Text style={footerText}>This message was sent from the contact form on your website.</Text>
          <Text style={footerText}>Reply directly to this email to respond to {name}.</Text>
        </Section>
      </Container>
    </Body>
  </Html>
