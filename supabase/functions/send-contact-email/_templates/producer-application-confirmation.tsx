...
export const ProducerApplicationConfirmation = ({ name }: ProducerApplicationConfirmationProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          ...
          <Text style={tagline}>LA MÚSICA ES MEDICINE</Text>
        </Section>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Thank you for applying to join the <strong>Hecho En America</strong> producer network! We're excited to
            review your application and learn more about your work.
          </Text>
          ...
          <Section style={stepsSection}>
            ...
            <Text style={stepItem}>
              <strong>2. Google Meet Interview</strong>
              <br />
              If your application stands out, we'll reach out to schedule a video call to discuss the opportunity
              further.
            </Text>

            <Text style={stepItem}>
              <strong>3. Onboarding & Discord Access</strong>
              <br />
              Approved producers will be onboarded to our platform and given access to our{" "}
              <strong>Discord server</strong>, where you'll receive and accept projects from artists.
            </Text>
          </Section>
          ...
          <Text style={paragraph}>If you have any questions in the meantime, feel free to reply to this email.</Text>
        ...
        <Section style={footer}>
          <Text style={footerText}>© {new Date().getFullYear()} Hecho En America. All rights reserved.</Text>
          <Text style={footerText}>La Música Es Medicine 🎵</Text>
        </Section>
      </Container>
    </Body>
  </Html>
