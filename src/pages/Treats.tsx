    ...
    >
      <Card className="bg-gradient-to-br from-purple-900/100 via-pink-900/200 to-red-900/100 border-purple-500/60 hover:border-pink-400/70 transition-all duration-300 hover:shadow-2xl hover:shadow-pink-500/25 backdrop-blur-md overflow-hidden h-full">
        ...
        <div className="relative h-32 sm:h-40 md:h-48 overflow-hidden">
          ...
          {/* Play/Pause button overlay - only for audio samples */}
          {product.category === 'samples' && product.audio_preview_url &&
            <motion.button 
        ...
        <CardContent className="space-y-4">
          {/* Waveform animation - only for samples and non-instrument VSTs with audio */}
          {(product.category === 'samples' || 
            (product.category === 'vsts' && !product.is_instrument && (product.audio_preview_dry || product.audio_preview_wet || product.audio_preview_url))) && (
