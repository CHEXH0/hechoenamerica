...
import { Headphones, Mic, Music, LucideIcon } from "lucide-react";
...
const Services = () => {
  ...
  const getIconComponent = (iconName: string): LucideIcon => {
    ...
    return iconMap[normalizedName] || Music;
  };
  ...
  if (error) {
    return (
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-800/80 via-purple-900/60 to-black">
        <div className="text-white">Error loading services</div>
      </section>
    );
  }
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                  <div className="flex items-center mb-3">
                    <IconComponent className="h-6 w-6 text-purple-400 mr-3" />
